export default {
  ...
  'wifiGuide.step': '步骤',
  'wifiGuide.step1': '步骤1：打开手机，查找Xiaoxin开头的WIFI并连接',
  'wifiGuide.step2': '步骤2：①在弹出的联网界面中，选择自己的WIFI。②输入WIFI密码 ③点击开始连接，进入配网状态',
  'wifiGuide.step3': '步骤3：配网中',
  'wifiGuide.step4': '步骤4：配网成功提示',
  'wifiGuide.step5': '步骤5：配网成功，设备重启中'
}